...
from app.mcp_server.tools.context_retrieval.refresh_cache.schemas import RefreshCacheOutput
...
async def run(
    ...
    Args:
        ...
        fetcher:         Async callable (url) -> FetchWebResourceOutput.
                         Injected by MCPExecutor via the fetch_web_resource dependency.
