...
from app.mcp_server.tools.file_ops.search_files.schemas import SearchFilesOutput
...
async def run(pattern: str, directory: str = ".", sandbox_root: Path = None) -> SearchFilesOutput:
